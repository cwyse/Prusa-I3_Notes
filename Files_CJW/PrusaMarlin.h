...
#define STRING_VERSION_CONFIG_H "2014-02-05" //Personal revision number for changes to THIS file.
#define STRING_CONFIG_H_AUTHOR "Cagy-1st-Prusa-i3" //Who made the changes for Prusa Mendel
...
#define INVERT_X_DIR false   // for Mendel set to false, for Orca set to true, for Prusa set to false
#define INVERT_Y_DIR false    // for Mendel set to true, for Orca set to false, for Prusa set to false
...
#define X_MAX_LENGTH 200 //for Prusa
#define Y_MAX_LENGTH 200 //for Prusa
#define Z_MAX_LENGTH 150 //for Prusa
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,595.281328}  // (80,80,2560,600)
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,3200/1.25,650}  // default steps per unit for Prusa Mendel
